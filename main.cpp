...
std::string generateCode(int sideAmount, std::string shape, std::string unit) {
    std::string n = std::to_string(sideAmount);
    std::string res =
        "// Generated by https://github.com/ICS3U-Programming-AtriS/Assign-02-CPP"
        "\n// Date: "
        ...
        "\n    std::cout << \"This program calculates the Volume and Surface area\";"
        "\n    std::cout << std::endl;"
...
int main() {
    ...
    std::cout << "Of A Prism With The Same Dimensions And Also Because";
    ...
    // OUTPUT
    std::fstream ofs;
    std::string outputFilePath = "/home/vscode/ICS3U/Assign/Assign-02/Assign-02-CPP/OUTPUT/outputCode.cpp";
